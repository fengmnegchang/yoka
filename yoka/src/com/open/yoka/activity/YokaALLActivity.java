...
import com.open.yoka.adapter.AllClassAdapter;
import com.open.yoka.bean.AllBean;
 ...
 *****************************************************************************************************************************************************************************
 */
public class YokaALLActivity extends CommonFragmentActivity implements OnItemClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_yoka_all);
		init();
	}
	...
	protected void initValue() {
		...
		try {
			...
			for (ActivityInfo info : activities) {
				if (!YokaALLActivity.class.getName().equals(info.name)) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		if (bean != null && !YokaALLActivity.class.getName().equals(bean.getClassName())) {
