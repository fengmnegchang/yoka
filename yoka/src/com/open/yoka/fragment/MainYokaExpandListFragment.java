 ...
 ***************************************************************************************************************************************************************************** 
 */
public class MainYokaExpandListFragment extends MMainListBoxFragment {
	
	public static MainYokaExpandListFragment newInstance(String url, boolean isVisibleToUser) {
		MainYokaExpandListFragment fragment = new MainYokaExpandListFragment();
