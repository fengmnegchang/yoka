...
import com.open.yoka.adapter.m.MAdFocusViewPagerAdapter;
 ...
 *****************************************************************************************************************************************************************************
 */
public class CommonPagerFragment extends BaseV4Fragment<MSwiperJson, CommonPagerFragment>implements OnPageChangeListener{
	public ViewPager viewpager;
	public List<MSwiperBean> list = new ArrayList<MSwiperBean>();
	public MAdFocusViewPagerAdapter mIndexFocusPagerAdapter;
	...
	public void initValues() {
		...
		super.initValues();
		mIndexFocusPagerAdapter = new MAdFocusViewPagerAdapter(getActivity(),list);
	...
	public MSwiperJson call() throws Exception {
		...
		mIndexFocusJson.setList(MSwiperService.parseIndexFocus(url));
